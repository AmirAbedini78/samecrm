...
class FixCurrentUserPermissions extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fix:current-user-permissions';
     ...
     * @var string
     */
    protected $description = 'Fix permissions for current user';
    ...
    public function handle()
    {
        ...
        $this->info('All user permissions fixed successfully!');
        return 0;
    }
}
