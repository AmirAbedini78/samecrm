              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="APP_NAME" id="app_name" placeholder="SAME AFRAZ TAZHAK" required>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" placeholder="hello@sameafraz.com" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" placeholder="SAME AFRAZ TAZHAK (Optional)">
                    </div>
                  </div>
